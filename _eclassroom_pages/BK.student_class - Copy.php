             ...
             <h3 style="color:#e40087;margin:0px;padding:0px;"> Lectures (<?=$phpEasy->getrows1('lectures') ?>)</h3>
                        ...
                        padding:0px;color:#e40087;">'. $fetch['topic'] . '</h3>
                                         <small>course:
                                             ...
                                             href="#" style="color:#dedede" class="view" id="'. $fetch['id'] . '">view
                                             lecture</a>&nbsp;
                                         |&nbsp;<a
                                             href="#" style="color:#dedede" class="qtn" id="'. $fetch['id']. '">ask
                                            question</a><span class="qtnTimes'. $fetch['id']. '"> <b>('. $phpEasy->qtn
                                                 ($fetch['id']) .' )</b></span><small> on'.
                                       ...
                                       if($qt->rowCount() > 0)
                                             {
                                                 ...
                                                 print '<br/>
                                                 <h3 style="color:#FFF"> Question Asked</h3>
                                                 <hr/>';
